            ...
            <table class="table table-sm">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>John Doe</td>
                        <td>$157.00</td>
                        <td><span className="bg-danger text-light px-2 rounded-3">Unpaid</span></td>
                        <td><a className="fw-bold text-dark">View Check</a></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>John Doe</td>
                        <td>$157.00</td>
                        <td><span className="bg-success text-light px-2 rounded-3">Paid</span></td>
                        <td><a className="fw-bold text-dark">View Check</a></td>
                    </tr>
