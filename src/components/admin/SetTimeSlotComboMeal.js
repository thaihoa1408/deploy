...
function SetTimeSlotComboMeal(props) {
  //
  const [comboMealItems, setComboMealItems] = useState([
    {
      id: '1',
      value: 'Combo Meal 1',
      label: 'Combo Meal 1',
  ...
  const [comboMealItemSelect, setComboMealItemSelect] = useState(null);
  const handleSetComboMealItemSelect = (value) => {
    setComboMealItemSelect(value);
  };
  //store list
          ...
          <div className='row d-flex align-items-center'>
            <div className='col-12'>
              ...
              <div style={{ color: '#828282' }}>
                Home/Menu/Add Combo Meal/Time Slot
              </div>
            </div>
          </div>
              ...
              <div className='container-fluid p-1'>
                <div className='row mt-2'>
                  <div className='col-md-6 mb-2'>
                    <label className='form-label'>Select Combo Meal</label>
                    <MultiSelect
                      options={comboMealItems}
                      multi={true}
                      handleChange={handleSetComboMealItemSelect}
                      value={comboMealItemSelect}
                    />
                  </div>
                  <div className='col-md-6 mb-2'>
...
export default SetTimeSlotComboMeal;
