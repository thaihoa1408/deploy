...
export default function NavbarCust(props) {
  ...
  const { getTableNumber, user } = useCustContext();
  return (
    <Navbar expand='lg' className='bg-primary-3'>
      <Container
        fluid
        ...
        {props.page == 'home' && (
          <>
            ...
            <div className='text-truncate d-flex align-items-center'>
              ...
              />
              <div className='ms-2 text-secondary lh-sm'>
                <div className='small'>Guest User</div>
                <div className='fw-bold'>Tiger Puff</div>
              </div>
            </div>
          </>
        )}
